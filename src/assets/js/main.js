...
{{#each(renderObject.plugins)~}}
  {{#if(this.folder !== 'base')~}}
import { {{this.customRegComponents?this.customRegComponents:this.folder}}RegComponents, {{this.customRoutes?this.customRoutes:this.folder}}Routes, {{this.folder}}Store, {{this.folder}}RouterView } from "{{this.folder}}";
